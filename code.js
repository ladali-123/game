...
const foodSound = new Audio('Free Snack.mp3');
const gameOverSound = new Audio('gameover.mp3');
const moveSound = new Audio('move.mp3');
const musicSound = new Audio('Music_Mixkit.mp3');
let speed = 4;
let score = 0;
lastPaintTime = 0;
let snakeArr = [
...
function gameEngine() {
  ...
  if (isCollide(snakeArr)) {
    ...
    musicSound.pause();
    inputDir = { x: 0, y: 0 };
    alert("Game Over.Press any key to plain again.");
    snakeArr = [{ x: 13, y: 15 }];
    musicSound.play();
    score = 0;
  }
